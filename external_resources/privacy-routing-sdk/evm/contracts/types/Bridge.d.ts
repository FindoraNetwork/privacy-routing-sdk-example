...
export declare type ContractContext = Web3ContractContext<Bridge, BridgeMethodNames, BridgeEventsContext, BridgeEvents>;
export declare type BridgeEvents = 'Deposit' | 'FailedHandlerExecution' | 'Paused' | 'ProposalEvent' | 'ProposalVote' | 'RelayerAdded' | 'RelayerRemoved' | 'RelayerThresholdChanged' | 'RoleGranted' | 'RoleRevoked' | 'Unpaused';
export interface BridgeEventsContext {
    ...
    FailedHandlerExecution(parameters: {
        filter?: {};
        fromBlock?: number;
        toBlock?: 'latest' | number;
        topics?: string[];
    ...
    ProposalVote(parameters: {
        filter?: {};
        fromBlock?: number;
        toBlock?: 'latest' | number;
        topics?: string[];
    }, callback?: (error: Error, event: EventData) => void): EventResponse;
    RelayerAdded(parameters: {
        filter?: {};
        fromBlock?: number;
        toBlock?: 'latest' | number;
        topics?: string[];
    }, callback?: (error: Error, event: EventData) => void): EventResponse;
    RelayerRemoved(parameters: {
        filter?: {};
        fromBlock?: number;
        toBlock?: 'latest' | number;
        topics?: string[];
    }, callback?: (error: Error, event: EventData) => void): EventResponse;
    RelayerThresholdChanged(parameters: {
        filter?: {};
        fromBlock?: number;
        toBlock?: 'latest' | number;
        topics?: string[];
...
export declare type BridgeMethodNames = 'new' | 'DEFAULT_ADMIN_ROLE' | 'MAX_RELAYERS' | 'RELAYER_ROLE' | '_depositCounts' | '_domainID' | '_expiry' | '_fee' | '_hasVotedOnProposal' | '_relayerThreshold' | '_resourceIDToHandlerAddress' | '_totalRelayers' | 'adminAddRelayer' | 'adminChangeFee' | 'adminChangeRelayerThreshold' | 'adminPauseTransfers' | 'adminRemoveRelayer' | 'adminSetBurnable' | 'adminSetDepositNonce' | 'adminSetForwarder' | 'adminSetGenericResource' | 'adminSetResource' | 'adminUnpauseTransfers' | 'adminWithdraw' | 'cancelProposal' | 'deposit' | 'executeProposal' | 'getProposal' | 'getRoleAdmin' | 'getRoleMember' | 'getRoleMemberCount' | 'getRoleMemberIndex' | 'grantRole' | 'hasRole' | 'isRelayer' | 'isValidForwarder' | 'paused' | 'renounceAdmin' | 'renounceRole' | 'revokeRole' | 'transferFunds' | 'voteProposal';
...
export interface Bridge {
     ...
     */
    'new'(domainID: string | number, initialRelayers: string[], initialRelayerThreshold: string, fee: string, expiry: string): MethodReturnContext;
    /**
     * Payable: false
     * Constant: true
     ...
     */
    _hasVotedOnProposal(destNonce: string, dataHash: string | number[], relayer: string): MethodConstantReturnContext<boolean>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param valid Type: bool, Indexed: false
     */
    adminSetForwarder(forwarder: string, valid: boolean): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    adminSetGenericResource(handlerAddress: string, resourceID: string | number[], contractAddress: string, depositFunctionSig: string | number[], executeFunctionSig: string | number[]): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    adminWithdraw(handlerAddress: string, data: string | number[]): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     * @param data Type: bytes, Indexed: false
     */
    deposit(destinationDomainID: string | number, resourceID: string | number[], data: string | number[]): MethodPayableReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    executeProposal(domainID: string | number, depositNonce: string, data: string | number[], resourceID: string | number[], revertOnFail: boolean): MethodReturnContext;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param dataHash Type: bytes32, Indexed: false
     */
    getProposal(originDomainID: string | number, depositNonce: string, dataHash: string | number[]): MethodConstantReturnContext<ProposalResponse>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     */
    isValidForwarder(parameter0: string): MethodConstantReturnContext<boolean>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param data Type: bytes, Indexed: false
     */
    voteProposal(domainID: string | number, depositNonce: string, resourceID: string | number[], data: string | number[]): MethodReturnContext;
}
