...
export declare type ContractContext = Web3ContractContext<DeckAbi, DeckAbiMethodNames, DeckAbiEventsContext, DeckAbiEvents>;
export declare type DeckAbiEvents = 'Deposit' | 'FeeUpdated' | 'Initialized' | 'LiquidityAdded' | 'LiquidityRemoved' | 'MinAddUpdated' | 'OwnershipTransferred' | 'Paused' | 'PoolFeeAdd' | 'Unpaused' | 'Withdraw';
export interface DeckAbiEventsContext {
    Deposit(parameters: {
        filter?: {
...
export declare type DeckAbiMethodNames = 'MaxFee' | 'MaxFeePercent' | 'MaxFeeShare' | 'accountAssets' | 'addLiquidity' | 'addMarket' | 'addNativeLiquidity' | 'adminColumbusAssetAddress' | 'adminSetGenericHandler' | 'allMarkets' | 'baseToken' | 'cTokenForToken' | 'columbusAssetAddress' | 'deposit' | 'feeAdmin' | 'feeCounter' | 'feeShare' | 'fixedFee' | 'genericHandlerAddress' | 'getAssets' | 'initialize' | 'marketLen' | 'markets' | 'maxRedeem' | 'minAdd' | 'minFee' | 'nativeWrap' | 'owner' | 'paused' | 'removeLiquidity' | 'renounceOwnership' | 'setFee' | 'setFeeAdmin' | 'setFeeShare' | 'setFixedFee' | 'setMarket' | 'setMinAdd' | 'setWrap' | 'tokenForCToken' | 'transferOwnership' | 'withdraw' | 'withdrawFee';
...
export interface DeckAbi {
     ...
     */
    adminColumbusAssetAddress(asset: string): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    deposit(data: string | number[]): MethodReturnContext;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param asset Type: address, Indexed: false
     */
    initialize(handler: string, asset: string): MethodReturnContext;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param data Type: bytes, Indexed: false
     */
    withdraw(data: string | number[]): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
