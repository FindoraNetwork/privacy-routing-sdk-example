...
export declare type ContractContext = Web3ContractContext<PrismBridge, PrismBridgeMethodNames, PrismBridgeEventsContext, PrismBridgeEvents>;
export declare type PrismBridgeEvents = 'DepositFRA' | 'DepositFRC1155' | 'DepositFRC20' | 'DepositFRC721' | 'OwnershipTransferred' | 'WithdrawFRA' | 'WithdrawFRC1155' | 'WithdrawFRC20' | 'WithdrawFRC721';
export interface PrismBridgeEventsContext {
